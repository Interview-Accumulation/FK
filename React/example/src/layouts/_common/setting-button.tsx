		...
		<>
							...
							{isFullscreen ? (
								<>
									<SvgIcon
										...
										className="!m-0"
									/>
									<span className="ml-2">{t("common.exitFullscreen")}</span>
								</>
							) : (
								<>
									<SvgIcon icon="ic-settings-fullscreen" className="!m-0" />
									<span className="ml-2 text-gray">{t("common.fullscreen")}</span>
								</>
							)}
						</div>
					</Button>
			...
			>
				<div className="flex flex-col gap-6 p-6">
					{/* theme mode */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">{t("common.mode")}</div>
					...
					{/* theme layout */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">{t("common.layout")}</div>
					...
					{/* theme presets */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">{t("common.theme")}</div>
					...
					{/* font */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">{t("common.font")}</div>

						<div className="my-3 text-sm font-semibold text-text-disabled">{t("common.family")}</div>
						...
						<div className="my-3 text-sm font-semibold text-text-disabled">{t("common.size")}</div>
						<Slider min={12} max={20} defaultValue={fontSize} onChange={setFontSize} />
					</div>

					{/* Page config */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">{t("common.page")}</div>
