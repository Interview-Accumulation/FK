...
function transformPermissionToMenuRoutes(
  ...
  return permissions.map((permission) => {
    ...
    console.log('getCompleteRoute', getCompleteRoute(permission, flattenedPermissions))
...
export function usePermissionRoutes() {
  ...
  return useMemo(() => {
    const flattendPermissions = flattenTrees(permissions);
    const permissionRoutes = transformPermissionToMenuRoutes(permissions || [], flattendPermissions);
